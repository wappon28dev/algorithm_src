...
#### 配列
配列の添字は, `0` から始まることが多いが, プログラム言語によっては `1` から始まる場合もある. (例: Luaとか)  
...
#### レコード
C言語では, レコードを扱うデータ構造として, **構造体 (structure)** というデータ型が用意されている.
